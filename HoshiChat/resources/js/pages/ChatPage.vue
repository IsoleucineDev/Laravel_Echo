...
export default {
  ...
  methods: {
    ...
    async sendMessage() {
      ...
      this.newMessage = '';
      try {
        await useMessages().createMessage(this.selectedConversationId, content, this.token);
      } catch (error) {
    ...
    async createConversation() {
      ...
      try {
        await useConversations().createConversation(this.newConversationData, this.token);
